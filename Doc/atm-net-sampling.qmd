...
In summer 2019, an ATM survey was conducted aboard Lasker over the continental shelf (\~25-2,000 m seabed depth) in the CCE between Cape Flattery, WA and San Diego, CA (@fig-survey-map). During the day, acoustic backscatter was measured along transects oriented perpendicular to the coast, then catches from up to three surface trawls towed at night were used to describe the lengths and species composition of fishes where backscatter was observed the previous day. Along the WA and OR coast, *Lisa Marie* conducted acoustic and purse-seine sampling along 5 nmi-long transects in shallow areas (\<25 m) where sampling by *Lasker* was inefficient, unsafe, or both.
